    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
        ...
        <div class="col-span-1 md:col-span-9">
            <img src="{{ Storage::url($category->photo) }}"
                class="object-top object-cover h-56 md:h-64 w-full rounded-lg">

            <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                <div class="col-span-1 md:col-span-12 px-3 py-4 rounded bg-gray-50 dark:bg-gray-800 mt-4">
                    <p class="text-xl text-justify text-gray-900 dark:text-gray-100">
                ...
                @foreach ($products as $product)
                    <x-card-product>
                        ...
                        @slot('button')
                            ...
                            <x-btn-blue wire:click='modalAdd({{ $id }})' class="text-center">
                                @slot('content')
                                    {{ __('Add') }}
                                @endslot
                            </x-btn-blue>
